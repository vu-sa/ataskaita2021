<section id="mvp">
    ...
    <p>The VU SR annual activity plan consists of strategic goals and goals set by VU SR units. Strategic goals are aimed for change on the University scale. This concept encompasses actions initiated by VU SR, which aim to solve problems relevant to all students of Vilnius University. The goals of VU SR units are intended to ensure the improvement of students' social and academic environment in each core academic unit (hereinafter – CAU) of Vilnius University and are set taking into account the needs of students of each CAU individually. </p>
    <p>Purposefully striving for the changes set out in the annual activity plan, the implementation of the goals continues after the VU SR Convention. Therefore, the results of the implementation of the annual activity plan reviewed in this report are not final and the activities will be carried on.  </p>
    <p>For more details on the annual activity plan and the course of the planning process, see: 
www.vusa.lt → Documents → Operating documents. </p>
    <p>We invite you to get acquainted with the results of the goals set in the 2020-2021 annual activity plan. </p>

    <p style="font-size: 50px; text-align: center;"><b>
    VU SR STRATEGIC GOALS </b></p>
    <p>
    ...
    <br>
    <p>
        <h4><strong>Goal:</strong>
        August 1st 2021, at least 75% of VU students rate their distance learning experience* more positively than negatively. 
        <br>* The quality of teaching, independent learning / workload, students’ motivation and involvement in studies, satisfaction with studies. 
        </h4>
    ...
    <p>
        <h4><strong>Goal:</strong>
        July 1st 2021, the VU SR consulting process system is created and implemented and the negative feedback about consulting from students is reduced by 30%.
        </h4>
        <p><strong>How much has been achieved:</strong>
    ...
    <p>
        <h4><strong>Goal:</strong>
        By 2022 the integration measures implemented at Vilnius University increase the satisfaction of I (bachelor), II (master’s), integrated, III (doctoral) study cycle students with their studies and the number of I (bachelor), II (master’s) cycles and integrated studies graduates. </h4>
        <p><strong>How much has been achieved:</strong>
    ...
    VU SR GOALS SET BY THE UNITS (by objective groups) </b></p>
    <h1>
    <h3 style="text-align: center;"><b>
    TEACHING METHODS A STUDENT-ORIENTED / ENGAGING TEACHING METHODS </b></p>
    <h3>
    <BR>

    <p>
        <h4><strong>Goal:</strong>
        June 23rd 2021 In VU SR EVAF economics and management study programs, at least 10 lecturers provide useful updated materials for the taught subjects, using methods that engage students. Student surveys have almost no negative feedback on the methods used by those lecturers and the material provided. 
        </h4>
        <p><strong>How much has been achieved:</strong>
    ...
    <p>
        <h4><strong>Goal:</strong>
        July 1st 2021, at least 20 I cycle and 10 II study cycle subjects have teaching methods that are student-oriented based on their feedback and recommendations. 
        </h4>
        <p><strong>How much has been achieved:</strong>
    ...
    <p>
        <h4><strong>Goal:</strong>
        July 1st 2021, at least 3 I study cycle and 3 II study cycle VU FF lecturers use VU SR FF recommended, student-oriented teaching / learning methods.
        </h4>
        <p><strong>How much has been achieved:</strong>
    ...
    <p>
        <h4><strong>Goal:</strong>
        June 30th 2021, at least 50% of the lecturers who have attended the training provide positive feedback and update their methods of testing their subject knowledge. 
        </h4>
        <p><strong>How much has been achieved:</strong>
    ...
    <h3 style="text-align: center;"><b>
    REVISED AND, BASED ON DEMAND, UPDATED ASSESSMENT CRITERIA OR STRATEGY (MODULES, SMVT) </b></p>
    <h3>
    <BR>

    <p>
        <h4><strong>Goal:</strong>
        June 30th 2021, VU EVAF has an improved system of dividing students into specializations (branches of studies), which assesses not only study achievements, but also takes into account the student’s wishes and motivation. 
        </h4>
        <p><strong>How much has been achieved:</strong>
    ...
    <p>
        <h4><strong>Goal:</strong>
        September 1st 2021, modules of at least 3 VU MIF study programs’ unified teaching and assessment system is agreed upon with the lecturers of the practice lectures. 
        </h4>
        <p><strong>How much has been achieved:</strong>
    ...
    <p>
        <h4><strong>Goal:</strong>
        June 30th 2021, the evaluation criteria of students' scientific activity are reviewed, updated and approved by the VU MF Council. 
        </h4>
        <p><strong>How much has been achieved:</strong>
    ...
    <h3 style="text-align: center;"><b>
    COURSE (MODULE) DESCRIPTIONS (UPDATES, DEVELOPMENT) </b></p>
    <h3>
    <BR>

    <p>
        <h4><strong>Goal:</strong>
        July 1st 2021, the objectives of subject foreign language subjects (modules) are updated based on the specifics of each VU IF bachelor study program. 
        </h4>
        <p><strong>How much has been achieved:</strong>
    ...
    <p>
        <h4><strong>Goal:</strong>
        July 9th 2021, one new elective subject is developed and approved for the first cycle study fields of informatics and mathematics, which are accessible to everyone. 
        </h4>
        <p><strong>How much has been achieved:</strong>
    ...
    <p>
        <h4><strong>Goal:</strong>
        July 1st 2021, VU TSPMI has approved the description of one elective subject in the field of economics. 
        </h4>
        <p><strong>How much has been achieved:</strong>
    ...
    <p>
        <h4><strong>Goal:</strong>
        July 1st 2021, at least 12 integrated law studies, I-VII semesters, subjects are updated to include assessment criteria. 
        </h4>
        <p><strong>How much has been achieved:</strong>
    ...
    <h3 style="text-align: center;"><b>
    COURSE / WRITING WORKS  </b></p>
    <h3>
    <BR>

    <p>
        <h4><strong>Goal:</strong>
        July 1st 2021, based on the established criteria, the procedure for preparation, defence and evaluation of term papers for each VU GMC I cycle study program has been prepared and uploaded to www.gmc.vu.lt. 
        </h4>
        <p><strong>How much has been achieved:</strong>
    ...
    <p>
        <h4><strong>Goal:</strong>
        June 7th 2021, students of the 1st cycle study programs of VU CHGF Institute of Chemistry in each study program have the opportunity to independently plan and perform experiments on the basis of topics provided by the lecturers at least once a semester. 
        </h4>
        <p><strong>How much has been achieved:</strong>
    ...
    <p>
        <h4><strong>Goal:</strong>
        July 1st 2021, VU FLF community is aware of the importance of academic ethics and the actions that can be taken in the event of breaches of academic ethics. 
        </h4>
        <p><strong>How much has been achieved:</strong>
    ...
    <p>
        <h4><strong>Goal:</strong>
        July 1st 2021, VU GMC students are provided with information about the internship procedure and opportunities to do it in other institutions, therefore 10% more students do internships outside VU GMC boundaries*. </p>

        <p>* Boundaries - institutes of biochemistry, biotechnology, life sciences.  </p>
        </h4>
        <p><strong>How much has been achieved:</strong>
    ...
    <p>
        <h4><strong>Goal:</strong>
        From December 1st 2020 VU KnF students can and will be able to choose from general university studies (GUS) subjects (modules) offered to students at the University, in which at least 20% of the subjects are coordinated by non-KnF lecturers are available to KnF students.
        </h4>
        <p><strong>How much has been achieved:</strong>
    ...
    <p>
        <h4><strong>Goal:</strong>
        July 1st 2021, VU KnF students’ satisfaction with studies reaches 75%. 
        </h4>
        <p><strong>How much has been achieved:</strong>
    ...
    <p>
        <h4><strong>Goal:</strong>
        September 31st 2021, VU KF has established at least one nominal scholarship. 
        </h4>
        <p><strong>How much has been achieved:</strong>
    ...
    <p>
        <h4><strong>Goal:</strong>
        May 31st 2021, at least 2 measures are applied to reduce the stress and psychological pressure experienced in the study programs organized by VU MF. 
        </h4>
        <p><strong>How much has been achieved:</strong>
    ...
    <p>
        <h4><strong>Goal:</strong>
        Before the 2021 VU SR ŠA ordinary Convention, student representatives present a report of the SPC at a meeting at least once. 
        </h4>
        <p><strong>How much has been achieved:</strong>
    ...
    <p>
        <h4><strong>Goal:</strong>
        June 1st 2021, VU VM has a feedback collection system, based on which at least 5 I cycle hand 2 II cycle study subjects have been improved.
        </h4>
        <p><strong>How much has been achieved:</strong>
