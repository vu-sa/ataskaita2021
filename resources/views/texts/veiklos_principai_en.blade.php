...
<h2><b>The Strategy of Vilnius University Students’ Representation </b></h2>
        ...
        <img width= "40%" class="center" height=auto src="/img/VU-SA-schema-en.png">
    </section>
    ...
    <section id="aukstojo-mokslo-schema">
        ...
        <li><strong>CHGF: </strong>Jorigis Marčėnas, Egita Banevičiūtė,Lavija Žibutytė</li>
            ...
            <li><strong>FSF: </strong>Domantė Dargevičiūtė, Aistė Pačebutaitė (until 2021 March), 
            Viltė Jankauskaitė (from 2021 March), Aistė Rinkevičiūtė</li>
            ...
            <li><strong>ŠA: </strong>Paulius Ladukas (until 2021 February), 
            Akvilė Bušininkaitė (from 2021 February), 
            Ieva Šukytė (from 2021 February)</li>
...
During the reference period, Artūras Anisimenka (the head of the group), Vanesa Ražinskytė, Vytautas Pasvenskas, Dominykas Mečanec, Airina Mikulėnaitė and Rūta Dikčiūtė were a part of this group. 
    ...
    <section id="taryba">
    <h2 style="text-align: center"><b>VU SR BOARD </b></h2>
    <h4 style="text-align: center">2020–2021 m. VU SR Board consisted of: </h4>
    <section id="aukstojo-mokslo-schema">
        <ul>
