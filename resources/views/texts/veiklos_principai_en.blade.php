...
<section id="apie-vusa" title="Apie VUSA">
  ...
  <div class="column2">-->
    <h2>About VU SA</h2>
        <p><strong>Vilnius University Students’ Representation (VU SR, lt. VU SA) </strong>
        is the oldest and the biggest expert education organization in Lithuania. It represents the interests of students at Vilnius University and beyond, fostering university culture and creating the most favourable conditions for students’ self-expression.  
        </p>
        <p>In total, VU SA has 15 units in each core academic unit (faculty, institute, or centre) that represent students locally. VU SA also has 15 programs, clubs, projects and public bodies (lt. PKP) as well as one Central Office, which coordinates all the units, PKP and Vilnius University Alumni Society. For this day VU SA unites around 1 000 members.  
        </p>
        <p><strong>VU SA:</strong></p>
        <ul>
            <li>represents students – defends students’ rights in University’s governing bodies and on the national level;  </li>
            <li>contributes to the improvement of the study process in the University, is a part of all the most important governing bodies of Vilnius University;    </li>
            <li>takes care of social welfare – provides a comfortable and student–friendly environment, takes care of student integration, participates in the distribution of scholarships;  </li>
            <li>organizes meaningful leisure time;  </li>
            <li>spreads the information so that all relevant news reaches the students. </li>
        </ul>
        <!--</div>
...
<h2><b>The Strategy of Vilnius University Students’ Representation </b></h2>
        <p><strong>VU SA Vision </strong> – an open environment for independent student development in the unified community of Vilnius University.  
        </p>
        <p><strong>VU SA Mission</strong> – to create the most favourable conditions for student self-expression by effectively representing the students of Vilnius University and fostering the university culture. 
        </p>
        ...
        <p><strong>Strategic directions: </strong>
        <ul>
            <li>High quality studies and their environment; </li>
            <li>Strong organization;  </li>
            <li>Sustainable University community. </li>
        </ul>
        </p>
    ...
    <section id="taryba">
    <h2><b>VU SR BOARD </b></h2>
    <h4>2020–2021 m. VU SR Board consisted of: </h4>
    <section id="aukstojo-mokslo-schema">
        <ul>
            <li><strong>VU SR President  </strong>Justas Kvedaravičius</li>
            <li><strong>VU SR CHGF: </strong>Jorigis Marčėnas</li>
            <li><strong>VU SR EVAF: </strong>Nadia Ronlev</li>
            <li><strong>VU SR FF: </strong>Raimondas Šiškevičius </li>
            <li><strong>VU SR FILF: </strong>Elena Pranevičiūtė</li>
            <li><strong>VU SR FSF: </strong>Domantė Dargevičiūtė</li>
            <li><strong>VU SR GMC: </strong>Martynas Arbačiauskas</li>
            <li><strong>VU SR IF: </strong>Augustė Grakavinaitė</li>
            <li><strong>VU SR KF: </strong>Kristijonas Ražickas</li>
            <li><strong>VU SR KnF: </strong>Neda Žutautaitė</li>
            <li><strong>VU SR MF: </strong>Tautvydas Petkus</li>
            <li><strong>VU SR MIF: </strong>Rita Žilinskaitė</li>
            <li><strong>VU SR ŠA: </strong>Paulius Ladukas</li>
            <li><strong>VU SR TF: </strong>Airina Mikulėnaitė</li>
            <li><strong>VU SR TSPMI: </strong>Julija Jarutytė</li>
            <li><strong>VU SR VM: </strong>Justinas Brazaitis</li>
        </ul>
        <p>
            <strong>VU SR Board </strong>– VU SR governing body dealing with cooperation and internal issues of the organization. This governing body consists of the heads (chairmen and chairwomen) of the representative units of the Organization and the president, who organizes the activities of this governing body. During the reference period, 11 meetings of the VU SR Board took place. The Board of VU SR discussed and made decisions on institutional strengthening, internal affairs, and budget. 
        </p>
        </p>
        <strong>Internal affairs  </strong>
        </p>
        </p>
        During the reference period, the VU SR Board approved the composition of the VU Foundation for Institutional Strengthening, as well as approved the job descriptions of the socio-academic process, marketing, organizational affairs, and representative coordinators of the core academic units.
        </p>
        <p>
            <strong>The Board of VU SR made decisions: </strong>
        </p>
        <ul>
            <li>Taking into account the conclusions of the Revision Commission of VU SR, it was decided to update the archive of VU SR; </li>
            <li>in accordance with the strategic goal, create and implement the VU SR consultation process system and reduce student negative feedback by 30 percent on counseling. Therefore, it was decided to convene a VU SR consulting working group to create a e-counseling system (to consult on social, academic, LSIC issues, opportunities for students' self-expression at the University, such as PCP, services provided by the University, tutors should consult on dormitories, transport, teachers, etc.); </li>
            <li>to extend the period of taking the social and academic knowledge test until 15 November due to the subsequent inclusion of members in the activities of VU SR, and to send the lists of members until 20 November; </li>
            <li> the proposal to sign the position of the Liberal Youth of Vilnius on the decriminalization of small quantities of drugs was decided to be considered by the VU SR Parliament; </li>
            <li>convene a working group on the issue of membership in the organization. The working group consists of representatives from different bodies of VU SR (Institutional Strengthening Fund, Central Office and Board). The purpose of the working group is to review the nature of membership and the issue of membership in the organization. Reviewing the processes taking place in the organization, the ideas expressed by the members, the working group prepares proposals aimed at making the membership more efficient. </li>
        </ul>
    ...
    <h2><b>VU SA Parliament</b></h2>
    <h4>Aistė Pačebutaitė (until March 2021) and Augustė Grakavinaitė (since March 2021) was the chairpersons of VU SA Parliament during the reference period. </h4>
    <h4>In 2020–2021 the members of VU SA Parliament were: </h4>
    <section id="aukstojo-mokslo-schema">
        <ul>
            <li><strong>VU SA President</strong>Justas Kvedaravičius </li>
            ...
            <li><strong>ŠA: </strong>Paulius Ladukas (since February 2021) , 
            Akvilė Bušininkaitė (since February 2021), 
            Ieva Šukytė (since February 2021)</li>
            ...
            <li><strong>FSF: </strong>Domantė Dargevičiūtė, Aistė Pačebutaitė(until March 2021), 
            Viltė Jankauskaitė (since March 2021), Aistė Rinkevičiūtė</li>
        ...
        <p>
        Temporary working groups were formed to produce the resolutions regarding the issue of emotional environment / recommendations, regarding the student employment during studies.         </p>
        <p>
        <p>
        ...
        <p>
            ...
            <strong>VU SA Parliament Legal working group </strong>
        </p>
        <p>
        The Legal Working Group is a permanent working group of the VU SA Parliament. The main goal of the Legal Working Group is to ensure the compliance of the documents regulating the activities of VU SA with the documents of higher power, provide legal conclusions. </p><p>
During the reference period, Artūras Anisimenka (the head of the group), Vanesa Ražinskytė, Vytautas Pasvenskas, Dominykas Mečanec, Airina Mikulėnaitė and Rūta Dikčiūtė were a part of this group. 
        ...
        <p>
            <strong>Resolution on Emotional Well-being in Higher School </strong></p>
        <p>
        ...
        <p>
            <strong>VU SA Student Work program </strong></p>
        <p>
        In order to create conditions for not having to work and improve the material conditions of the higher education community VU SA: 
            <p><strong>1.1. </strong>is guided by the provision that the participants of the study process must be provided with all the material and infrastructure needed for the implementation of a quality study process;</p>
            <p><strong>1.2. </strong>cooperates with other organizations seeking higher funding for higher education and studies</p>
        </p>

        <p>
            <strong>Resolution on Students’ Employment During Studies </strong></p>
        <p>
        ...
        <p>
            <strong>The position on Assistance to Students Affected by the COVID-19 Pandemic</strong></p>
        <p>
        ...
        <p>
            <strong>Resolution on Ensuring Equal Opportunities and Promoting Diversity at Vilnius University </strong></p>
        <p>
        ...
        <h2><b>Review of the findings of VU SA research on procedure for conducting internships at Vilnius University </b></h2>
        ...
        <ul>
        <li>Haroldas Vitunskas (Chairman of the Commission) </li>
